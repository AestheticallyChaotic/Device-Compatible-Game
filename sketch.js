...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    ...
    cash.x = Math.round(random(windowWidth, windowHeight));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    diamonds.x = Math.round(random(windowWidth, windowHeight));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    jwellery.x = Math.round(random(windowWidth, windowHeight));
